...
| A_ScreenScale | 🟢 Full | 🟢 Full | 🟢 Full | 🟢 Full | The primary monitor's authored-size scale in native screen units. 1.0 is 100%; Windows and X11 can return a larger value, while macOS and Wayland return 1.0 because their native coordinate spaces already account for UI scaling. Apply it to deliberately scalable dimensions, never absolute positions; use MonitorGetScale for mixed-monitor layouts. |
