...
| Clr() | 🟢 Full | 🟢 Full | 🟢 Full | 🟢 Full | Creates the platform-independent CLR interop facade for loading and invoking .NET types. Buffer arguments are copied to byte[] parameters; byte spans view Buffer storage directly. |
