...
| Throw | 🟢 Full | 🟢 Full | 🟢 Full | 🟢 Full | Throws an Error, or another value wrapped as Error(Value). Without a value it rethrows the error an active catch handles, or raises the continuable Error("An exception was thrown."). |
