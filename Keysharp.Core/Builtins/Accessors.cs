namespace Keysharp.Builtins
{
	...
	public static class Accessors
	{
		...
		/// </summary>
		public static string A_AhkVersion => "2.1-alpha.32";
...
#error Unsupported platform. Only WINDOWS, LINUX, and OSX are supported.
		...
		/// which the call stack names like any other script function.
		/// </para>
		/// </summary>
		public static string A_ThisFunc => CallStack.Current.FunctionName;
